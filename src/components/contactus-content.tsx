...
export function ContactUsContent() {
  return (
    <div className="text-left">
      ...
      <p className="mb-3">
        I thought about trying to eliminate both of these types of useless (or almost useless) conversions. But I decided against that. The whole point of this exercise was to find out what the math tells you to do.
      </p>

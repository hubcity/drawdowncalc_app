...
export function DisclaimerContent() {
    return (
        <div className="text-left"> {/* Or apply text-left to the parent in page.tsx */}
            ...
            <p className="mb-3">
                By understanding these inherent limitations, DrawdownCalc can be a useful tool for your retirement planning.
            </p>

            <h3 className="text-base font-semibold mb-2">IMPORTANT DISCLAIMER</h3>
            <p className="mb-3">
                DrawdownCalc is an exploratory tool provided for informational and educational purposes only. The calculations and plans generated are based entirely on the assumptions you provide and the simplified mathematical model described above.
            </p>
            <p className="mb-3">
